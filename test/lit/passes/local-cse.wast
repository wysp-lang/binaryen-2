...
(module
  ...
  ;; NONLC-NEXT:  )
  ;; NONLC-NEXT:  (drop
  ;; NONLC-NEXT:   (block $block0 (result i32)
  ;; NONLC-NEXT:    (drop
  ;; NONLC-NEXT:     (i32.const 10)
  ;; NONLC-NEXT:    )
  ;; NONLC-NEXT:    (drop
  ...
  ;; CHECK:      (func $loop-conditional-unreachable
  ;; CHECK-NEXT:  (local $x i32)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (i32.add
  ;; CHECK-NEXT:    (i32.const 10)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NONLC:      (func $loop-conditional-unreachable
  ;; NONLC-NEXT:  (local $x i32)
  ;; NONLC-NEXT:  (local $1 i32)
  ;; NONLC-NEXT:  (local $2 i32)
  ;; NONLC-NEXT:  (drop
  ...
  ;; NONLC-NEXT:  )
  ;; NONLC-NEXT: )
  (func $loop-conditional-unreachable (local $x i32)
    ;; As above, but add an unreachable at the end of the if arm. The initial
    ;; add still dominates all the rest.
    (drop
      (i32.add
        (i32.const 10)
        (local.get $x)
  ...
  ;; CHECK:      (func $later-uses-not-dominating
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (i32.add
  ;; CHECK-NEXT:    (i32.const 0)
  ;; CHECK-NEXT:    (i32.const 10)
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NONLC:      (func $later-uses-not-dominating
  ;; NONLC-NEXT:  (local $0 i32)
  ;; NONLC-NEXT:  (drop
  ;; NONLC-NEXT:   (local.tee $0
  ;; NONLC-NEXT:    (i32.add
  ...
  ;; CHECK:      (func $later-uses-dominating
  ;; CHECK-NEXT:  (local $0 i32)
  ;; CHECK-NEXT:  (drop
  ;; CHECK-NEXT:   (local.tee $0
  ;; CHECK-NEXT:    (i32.add
  ...
  ;; CHECK-NEXT:  )
  ;; CHECK-NEXT: )
  ;; NONLC:      (func $later-uses-dominating
  ;; NONLC-NEXT:  (local $0 i32)
  ;; NONLC-NEXT:  (drop
  ;; NONLC-NEXT:   (local.tee $0
  ;; NONLC-NEXT:    (i32.add
