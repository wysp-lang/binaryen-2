...
// Iterates over pointers to children. This allows modification of those
// pointers, and also includes pointers to children that are nullptr (and so it
// allows modifying them to contain actual values).
